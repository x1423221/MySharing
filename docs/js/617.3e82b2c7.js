 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pa=/^__.*__$/;class ma{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new jn(t,this.data,this.fieldMask,e,this.fieldTransforms):new Bn(t,this.data,e,this.fieldTransforms)}}class ya{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new jn(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function va(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw N()}}class wa{constructor(t,e,n,r,s,i){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===s&&this.Fu(),this.fieldTransforms=s||[],this.fieldMask=i||[]}get path(){return this.settings.path}get Mu(){return this.settings.Mu}xu(t){return new wa(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ou(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.xu({path:n,Nu:!1});return r.Lu(t),r}Bu(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.xu({path:n,Nu:!1});return r.Fu(),r}ku(t){return this.xu({path:void 0,Nu:!0})}qu(t){return Ma(t,this.settings.methodName,this.settings.Qu||!1,this.path,this.settings.Ku)}contains(t){return void 0!==this.fieldMask.find((e=>t.isPrefixOf(e)))||void 0!==this.fieldTransforms.find((e=>t.isPrefixOf(e.field)))}Fu(){if(this.path)for(let t=0;t<this.path.length;t++)this.Lu(this.path.get(t))}Lu(t){if(0===t.length)throw this.qu("Document fields must not be empty");if(va(this.Mu)&&pa.test(t))throw this.qu('Document fields cannot begin and end with "__"')}}class _a{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||ti(t)}$u(t,e,n,r=!1){return new wa({Mu:t,methodName:e,Ku:n,path:Z.emptyPath(),Nu:!1,Qu:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ba(t){const e=t._freezeSettings(),n=ti(t._databaseId);return new _a(t._databaseId,!!e.ignoreUndefinedProperties,n)}function Ea(t,e,n,r,s,i={}){const o=t.$u(i.merge||i.mergeFields?2:0,e,n,s);Ra("Data must be an object, but it was:",o,r);const a=ka(r,o);let u,c;if(i.merge)u=new Rt(o.fieldMask),c=o.fieldTransforms;else if(i.mergeFields){const t=[];for(const r of i.mergeFields){const s=xa(e,r,n);if(!o.contains(s))throw new O(L.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);Pa(t,s)||t.push(s)}u=new Rt(t),c=o.fieldTransforms.filter((t=>u.covers(t.field)))}else u=null,c=o.fieldTransforms;return new ma(new ae(a),u,c)}class Ta extends da{_toFieldTransform(t){if(2!==t.Mu)throw 1===t.Mu?t.qu(`${this._methodName}() can only appear at the top level of your update data`):t.qu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Ta}}function Ca(t,e,n){return new wa({Mu:3,Ku:e.settings.Ku,methodName:t._methodName,Nu:n},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class Sa extends da{constructor(t,e){super(t),this.Uu=e}_toFieldTransform(t){const e=Ca(this,t,!0),n=this.Uu.map((t=>Da(t,e))),r=new En(n);return new kn(t.path,r)}isEqual(t){return t instanceof Sa&&(0,u.bD)(this.Uu,t.Uu)}}function Ia(t,e,n,r){const s=t.$u(1,e,n);Ra("Data must be an object, but it was:",s,r);const i=[],o=ae.empty();Ct(r,((t,r)=>{const a=Oa(e,t,n);r=(0,u.Ku)(r);const c=s.Bu(a);if(r instanceof Ta)i.push(a);else{const t=Da(r,c);null!=t&&(i.push(a),o.set(a,t))}}));const a=new Rt(i);return new ya(o,a,s.fieldTransforms)}function Aa(t,e,n,r,s,i){const o=t.$u(1,e,n),a=[xa(e,r,n)],c=[s];if(i.length%2!=0)throw new O(L.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let u=0;u<i.length;u+=2)a.push(xa(e,i[u])),c.push(i[u+1]);const h=[],l=ae.empty();for(let f=a.length-1;f>=0;--f)if(!Pa(h,a[f])){const t=a[f];let e=c[f];e=(0,u.Ku)(e);const n=o.Bu(t);if(e instanceof Ta)h.push(t);else{const r=Da(e,n);null!=r&&(h.push(t),l.set(t,r))}}const d=new Rt(h);return new ya(l,d,o.fieldTransforms)}function Da(t,e){if(Na(t=(0,u.Ku)(t)))return Ra("Unsupported field value:",e,t),ka(t,e);if(t instanceof da)return function(t,e){if(!va(e.Mu))throw e.qu(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.qu(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.Nu&&4!==e.Mu)throw e.qu("Nested arrays are not supported");return function(t,e){const n=[];let r=0;for(const s of t){let t=Da(s,e.ku(r));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),r++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=(0,u.Ku)(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return mn(e.serializer,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=Q.fromDate(t);return{timestampValue:Er(e.serializer,n)}}if(t instanceof Q){const n=new Q(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:Er(e.serializer,n)}}if(t instanceof fa)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof ha)return{bytesValue:Tr(e.serializer,t._byteString)};if(t instanceof ea){const n=e.databaseId,r=t.firestore._databaseId;if(!r.isEqual(n))throw e.qu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Ir(t.firestore._databaseId||e.databaseId,t._key.path)}}if(t instanceof ga)return function(t,e){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:t.toArray().map((t=>{if("number"!=typeof t)throw e.qu("VectorValues must only contain numeric values.");return gn(e.serializer,t)}))}}}}}}(t,e);throw e.qu(`Unsupported field value: ${Wo(t)}`)}(t,e)}function ka(t,e){const n={};return St(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Ct(t,((t,r)=>{const s=Da(r,e.Ou(t));null!=s&&(n[t]=s)})),{mapValue:{fields:n}}}function Na(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof Q||t instanceof fa||t instanceof ha||t instanceof ea||t instanceof da||t instanceof ga)}function Ra(t,e,n){if(!Na(n)||!function(t){return"object"==typeof t&&null!==t&&(Object.getPrototypeOf(t)===Object.prototype||null===Object.getPrototypeOf(t))}(n)){const r=Wo(n);throw"an object"===r?e.qu(t+" a custom object"):e.qu(t+" "+r)}}function xa(t,e,n){if((e=(0,u.Ku)(e))instanceof la)return e._internalPath;if("string"==typeof e)return Oa(t,e);throw Ma("Field path arguments must be of type string or ",t,!1,void 0,n)}const La=new RegExp("[~\\*/\\[\\]]");function Oa(t,e,n){if(e.search(La)>=0)throw Ma(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new la(...e.split("."))._internalPath}catch(r){throw Ma(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Ma(t,e,n,r,s){const i=r&&!r.isEmpty(),o=void 0!==s;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let u="";return(i||o)&&(u+=" (found",i&&(u+=` in field ${r}`),o&&(u+=` in document ${s}`),u+=")"),new O(L.INVALID_ARGUMENT,a+t+u)}function Pa(t,e){return t.some((t=>t.isEqual(e)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Va{constructor(t,e,n,r,s){this._firestore=t,this._userDataWriter=e,this._key=n,this._document=r,this._converter=s}get id(){return this._key.path.lastSegment()}get ref(){return new ea(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const t=new Fa(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const e=this._document.data.field(Ua("DocumentSnapshot.get",t));if(null!==e)return this._userDataWriter.convertValue(e)}}}class Fa extends Va{data(){return super.data()}}function Ua(t,e){return"string"==typeof e?Oa(t,e):e instanceof la?e._internalPath:e._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class za{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class $a extends Va{constructor(t,e,n,r,s,i){super(t,e,n,r,i),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Ka(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Ua("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class Ka extends $a{data(t={}){return super.data(t)}}class Ga{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new za(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach((e=>t.push(e))),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach((n=>{t.call(e,new Ka(this._firestore,this._userDataWriter,n.key,n,new za(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new O(L.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map((n=>{const r=new Ka(t._firestore,t._userDataWriter,n.doc.key,n.doc,new za(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:e++}}))}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter((t=>e||3!==t.type)).map((e=>{const r=new Ka(t._firestore,t._userDataWriter,e.doc.key,e.doc,new za(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let s=-1,i=-1;return 0!==e.type&&(s=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),i=n.indexOf(e.doc.key)),{type:Ha(e.type),doc:r,oldIndex:s,newIndex:i}}))}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function Ha(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return N()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Qa(t){t=Xo(t,ea);const e=Xo(t.firestore,oa);return jo(ua(e),t._key).then((n=>tu(e,t,n)))}class Wa extends ja{constructor(t){super(),this.firestore=t}convertBytes(t){return new ha(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new ea(this.firestore,null,e)}}function Xa(t){t=Xo(t,ta);const e=Xo(t.firestore,oa),n=ua(e),r=new Wa(e);return Ba(t._query),qo(n,t._query).then((n=>new Ga(e,r,t,n)))}function Ya(t,e,n){t=Xo(t,ea);const r=Xo(t.firestore,oa),s=qa(t.converter,e,n);return Za(r,[Ea(ba(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,xn.none())])}function Ja(t,e,n,...r){t=Xo(t,ea);const s=Xo(t.firestore,oa),i=ba(s);let o;return o="string"==typeof(e=(0,u.Ku)(e))||e instanceof la?Aa(i,"updateDoc",t._key,e,n,r):Ia(i,"updateDoc",t._key,e),Za(s,[o.toMutation(t._key,xn.exists(!0))])}function Za(t,e){return function(t,e){const n=new M;return t.asyncQueue.enqueueAndForget((async()=>lo(await Uo(t),e,n))),n.promise}(ua(t),e)}function tu(t,e,n){const r=n.docs.get(e._key),s=new Wa(t);return new $a(t,s,e._key,r,new za(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eu(...t){return new Sa("arrayUnion",t)}new WeakMap;
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=617.3e82b2c7.js.map