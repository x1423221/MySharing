 ...
 * limitations under the License.
 */
const ae=Wt;function ce(t,e={}){let n=t;if("object"!==typeof e){const t=e;e={name:t}}const r=Object.assign({name:Xt,automaticDataCollectionEnabled:!1},e),s=r.name;if("string"!==typeof s||!s)throw ie.create("bad-app-name",{appName:String(s)});if(n||(n=b()),!n)throw ie.create("no-options");const i=Jt.get(s);if(i){if(L(n,i.options)&&L(r,i.config))return i;throw ie.create("duplicate-app",{appName:s})}const o=new j(s);for(const c of te.values())o.addComponent(c);const a=new oe(n,r,o);return Jt.set(s,a),a}function ue(t=Xt){const e=Jt.get(t);if(!e&&t===Xt&&b())return ce();if(!e)throw ie.create("no-app",{appName:t});return e}function he(t,e,n){var r;let s=null!==(r=Yt[t])&&void 0!==r?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const t=[`Unable to register library "${s}" with version "${e}":`];return i&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void Et.warn(t.join(" "))}ne(new P(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _n{constructor(t){this.path=t}static fromPath(t){return new _n(vn.fromString(t))}static fromName(t){return new _n(vn.fromString(t).popFirst(5))}static empty(){return new _n(vn.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return null!==t&&0===vn.comparator(this.path,t.path)}toString(){return this.path.toString()}static comparator(t,e){return vn.comparator(t.path,e.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new _n(new vn(t.slice()))}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class En{constructor(t,e,n,r){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=r}}En.UNKNOWN_ID=-1;function Tn(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,s=mn.fromTimestamp(1e9===r?new pn(n+1,0):new pn(n,r));return new Sn(s,_n.empty(),e)}function Cn(t){return new Sn(t.readTime,t.key,-1)}class Sn{constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}static min(){return new Sn(mn.min(),_n.empty(),-1)}static max(){return new Sn(mn.max(),_n.empty(),-1)}}function In(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:(n=_n.comparator(t.documentKey,e.documentKey),0!==n?n:fn(t.largestBatchId,e.largestBatchId)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _s=new Hn(_n.comparator);function Es(){return _s}const Ts=new Hn(_n.comparator);function Cs(...t){let e=Ts;for(const n of t)e=e.insert(n.key,n);return e}function Ss(t){let e=Ts;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function Is(){return Ds()}function As(){return Ds()}function Ds(){return new bs((t=>t.toString()),((t,e)=>t.isEqual(e)))}const ks=new Hn(_n.comparator),Ns=new Xn(_n.comparator);function Rs(...t){let e=Ns;for(const n of t)e=e.add(n);return e}const xs=new Xn(fn);function Ls(){return xs}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(){this.dr=new Xn(Uo.Ar),this.Rr=new Xn(Uo.Vr)}isEmpty(){return this.dr.isEmpty()}addReference(t,e){const n=new Uo(t,e);this.dr=this.dr.add(n),this.Rr=this.Rr.add(n)}mr(t,e){t.forEach((t=>this.addReference(t,e)))}removeReference(t,e){this.gr(new Uo(t,e))}pr(t,e){t.forEach((t=>this.removeReference(t,e)))}yr(t){const e=new _n(new vn([])),n=new Uo(e,t),r=new Uo(e,t+1),s=[];return this.Rr.forEachInRange([n,r],(t=>{this.gr(t),s.push(t.key)})),s}wr(){this.dr.forEach((t=>this.gr(t)))}gr(t){this.dr=this.dr.delete(t),this.Rr=this.Rr.delete(t)}Sr(t){const e=new _n(new vn([])),n=new Uo(e,t),r=new Uo(e,t+1);let s=Rs();return this.Rr.forEachInRange([n,r],(t=>{s=s.add(t.key)})),s}containsKey(t){const e=new Uo(t,0),n=this.dr.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class Uo{constructor(t,e){this.key=t,this.br=e}static Ar(t,e){return _n.comparator(t.key,e.key)||fn(t.br,e.br)}static Vr(t,e){return fn(t.br,e.br)||_n.comparator(t.key,e.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class wc{constructor(t){this.key=t}}class bc{constructor(t){this.key=t}}class _c{constructor(t,e){this.query=t,this.da=e,this.Aa=null,this.hasCachedResults=!1,this.current=!1,this.Ra=Rs(),this.mutatedKeys=Rs(),this.Va=vs(t),this.ma=new ic(this.Va)}get fa(){return this.da}ga(t,e){const n=e?e.pa:new oc,r=e?e.ma:this.ma;let s=e?e.mutatedKeys:this.mutatedKeys,i=r,o=!1;const a="F"===this.query.limitType&&r.size===this.query.limit?r.last():null,c="L"===this.query.limitType&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal(((t,e)=>{const u=r.get(t),h=ms(this.query,e)?e:null,l=!!u&&this.mutatedKeys.has(u.key),d=!!h&&(h.hasLocalMutations||this.mutatedKeys.has(h.key)&&h.hasCommittedMutations);let f=!1;u&&h?u.data.isEqual(h.data)?l!==d&&(n.track({type:3,doc:h}),f=!0):this.ya(u,h)||(n.track({type:2,doc:h}),f=!0,(a&&this.Va(h,a)>0||c&&this.Va(h,c)<0)&&(o=!0)):!u&&h?(n.track({type:0,doc:h}),f=!0):u&&!h&&(n.track({type:1,doc:u}),f=!0,(a||c)&&(o=!0)),f&&(h?(i=i.add(h),s=d?s.add(t):s.delete(t)):(i=i.delete(t),s=s.delete(t)))})),null!==this.query.limit)for(;i.size>this.query.limit;){const t="F"===this.query.limitType?i.last():i.first();i=i.delete(t.key),s=s.delete(t.key),n.track({type:1,doc:t})}return{ma:i,pa:n,ss:o,mutatedKeys:s}}ya(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,r){const s=this.ma;this.ma=t.ma,this.mutatedKeys=t.mutatedKeys;const i=t.pa.j_();i.sort(((t,e)=>function(t,e){const n=t=>{switch(t){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Xe()}};return n(t)-n(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new wu(this.firestore,t,this._query)}}class bu{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new _u(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new bu(this.firestore,t,this._key)}}class _u extends wu{constructor(t,e,n){super(t,e,os(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new bu(this.firestore,null,new _n(t))}withConverter(t){return new _u(this.firestore,t,this._path)}}function Eu(t,e,...n){if(t=M(t),hu("collection","path",e),t instanceof yu){const r=vn.fromString(e,...n);return fu(r),new _u(t,null,r)}{if(!(t instanceof bu||t instanceof _u))throw new tn(Ze.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(vn.fromString(e,...n));return fu(r),new _u(t.firestore,null,r)}}function Tu(t,e,...n){if(t=M(t),1===arguments.length&&(e=dn.newId()),hu("doc","path",e),t instanceof yu){const r=vn.fromString(e,...n);return du(r),new bu(t,null,new _n(r))}{if(!(t instanceof bu||t instanceof _u))throw new tn(Ze.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(vn.fromString(e,...n));return du(r),new bu(t.firestore,t instanceof _u?t.converter:null,new _n(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nu{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new tn(Ze.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new bn(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function lh(t){t=pu(t,bu);const e=pu(t.firestore,Su);return ou(Au(e),t._key).then((n=>yh(e,t,n)))}class dh extends sh{constructor(t){super(),this.firestore=t}convertBytes(t){return new ku(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new bu(this.firestore,null,e)}}function fh(t){t=pu(t,wu);const e=pu(t.firestore,Su),n=Au(e),r=new dh(e);return rh(t._query),au(n,t._query).then((n=>new uh(e,r,t,n)))}function gh(t,e,n){t=pu(t,bu);const r=pu(t.firestore,Su),s=ih(t.converter,e,n);return mh(r,[ju(Bu(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,Ys.none())])}function ph(t,e,n,...r){t=pu(t,bu);const s=pu(t.firestore,Su),i=Bu(s);let o;return o="string"==typeof(e=M(e))||e instanceof Nu?$u(i,"updateDoc",t._key,e,n,r):zu(i,"updateDoc",t._key,e),mh(s,[o.toMutation(t._key,Ys.exists(!0))])}function mh(t,e){return function(t,e){const n=new en;return t.asyncQueue.enqueueAndForget((async()=>Rc(await su(t),e,n))),n.promise}(Au(t),e)}function yh(t,e,n){const r=n.docs.get(e._key),s=new dh(t);return new ah(t,s,e._key,r,new oh(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
he(vh,wh,"app");const bh={apiKey:void 0,authDomain:"vuetest-35344.firebaseapp.com",projectId:"vuetest-35344",storageBucket:"vuetest-35344.firebasestorage.app",messagingSenderId:"2844207119",appId:"1:2844207119:web:687837aeece2bf9eea5b7a",measurementId:"G-42LZ3K97KN"},_h=ce(bh),Eh=Iu(_h);var Th=Eh;class Ch{constructor(t,e=[],n=[]){this.name=t,this.members=e,this.transactions=n}toMap(){return{name:this.name,members:this.members,transactions:this.transactions}}}var Sh=n(880);const Ih={key:0,class:"overlay"};var Ah={__name:"HomeComponents",setup(t){const e=(0,s.KR)(null),n=(0,s.KR)(null),o=(0,s.KR)(null),a=(0,s.KR)(!1);(0,r.sV)((async()=>{a.value=!0,await Sh.A.getProfile().then((t=>{console.log(t.displayName),e.value=t})).finally((()=>{a.value=!1}))}));const c=(0,i.rd)(),u=async()=>{a.value=!0;try{const t=Iu(),e=Eu(t,"241229Test"),n=await fh(e);n.forEach((t=>{const e=JSON.stringify(t.data());console.log("資料:"+JSON.stringify(e));const n="Uea43486b3bc11062986a319913daeb56",r=Object.entries(e).filter((([t,e])=>(console.log("key"+t),console.log("資料"+e),console.log("isArray"+Array.isArray(e.members)),console.log("members"+e.members),Array.isArray(e.members)&&e.members.includes(n)))),s=r.map((([t,e])=>({id:t,...e})));console.log("處理後資料:"+r),console.log(s)}))}catch(t){console.log(t)}try{const t=Tu(Th,"241229Test",e.value.userId),r=await lh(t);n.value=new Ch(`${e.value.displayName}的群組`),o.value=JSON.stringify(n.value),r.exists()?await ph(t,{[crypto.randomUUID()]:n.value.toMap()}):await gh(t,{[crypto.randomUUID()]:n.value.toMap()}).then((()=>console.log("Data saved successfully"))).catch((t=>console.error("Error saving data:",t))),sessionStorage.setItem("currentGroup",n.value.toMap())}catch(t){console.log(t+"新增資料失敗")}c.push({path:"/group",query:{id:e.value.userId}})},h=async()=>{a.value=!0,c.push({path:"/history"})};return(t,e)=>((0,r.uX)(),(0,r.CE)(r.FK,null,[a.value?((0,r.uX)(),(0,r.CE)("div",Ih,e[0]||(e[0]=[(0,r.Lk)("div",{class:"spinner"},null,-1)]))):(0,r.Q3)("",!0),(0,r.Lk)("div",{class:"home-container"},[e[1]||(e[1]=(0,r.Lk)("h1",null,"分帳輕鬆搞定",-1)),e[2]||(e[2]=(0,r.Lk)("p",null,"快速紀錄與分帳，讓金錢計算更簡單。",-1)),(0,r.Lk)("div",null,[(0,r.Lk)("button",{id:"btnCreateNew",class:"btn btn-success",onClick:u}," 建立新分帳 "),(0,r.Lk)("button",{id:"btnShowHis",class:"btn btn-success",onClick:h}," 檢視歷史紀錄 ")])])],64))}},Dh=n(1241);const kh=(0,Dh.A)(Ah,[["__scopeId","data-v-ec66dd7c"]]);var Nh=kh},1806:function(t,e,n){var r=n(6518),s=n(8551),i=n(2652),o=n(1767),a=[].push;r({target:"Iterator",proto:!0,real:!0},{toArray:function(){var t=[];return i(o(s(this)),a,{that:t,IS_RECORD:!0}),t}})},1795:function(t,e,n){n(1806)}}]);
//# sourceMappingURL=681.bef18bd2.js.map