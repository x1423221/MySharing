 ...
 * limitations under the License.
 */
he(lh,dh,"app");const fh={apiKey:void 0,authDomain:"vuetest-35344.firebaseapp.com",projectId:"vuetest-35344",storageBucket:"vuetest-35344.firebasestorage.app",messagingSenderId:"2844207119",appId:"1:2844207119:web:687837aeece2bf9eea5b7a",measurementId:"G-42LZ3K97KN"},gh=ue(fh),ph=Tc(gh);var mh=ph;class yh{constructor(t,e=[],n=[]){this.name=t,this.members=e,this.transactions=n}}var vh=n(880);const wh={key:0,class:"overlay"};var bh={__name:"HomeComponents",async setup(t){let e,n;const o=(0,s.KR)(null),a=(0,s.KR)(null),u=(0,s.KR)(null),c=(0,s.KR)(!1);(0,r.sV)((async()=>{c.value=!0,await vh.A.getProfile().then((t=>{console.log(t.displayName),o.value=t})).finally((()=>{c.value=!1}))}));const h=(0,i.rd)(),l=async()=>{c.value=!0;const t=bc(mh,"241229Test",o.value.userId),e=await ih(t);a.value=new yh(`${o.value.displayName}的群組`),u.value=JSON.stringify(a.value),e.exists()?await uh(t,{[crypto.randomUUID()]:u.value}):await ah(t,{[crypto.randomUUID()]:u.value}).then((()=>console.log("Data saved successfully"))).catch((t=>console.error("Error saving data:",t))),sessionStorage.setItem("currentGroup",u.value),h.push({path:"/group",query:{id:o.value.userId}})},d=async()=>{};h.push({path:"/history",query:{id:o.value.userId}});const f=bc(mh,"241229Test","Uea43486b3bc11062986a319913daeb56"),g=([e,n]=(0,r.E)((()=>ih(f))),e=await e,n(),e);return console.log(g),(t,e)=>((0,r.uX)(),(0,r.CE)(r.FK,null,[c.value?((0,r.uX)(),(0,r.CE)("div",wh,e[0]||(e[0]=[(0,r.Lk)("div",{class:"spinner"},null,-1)]))):(0,r.Q3)("",!0),(0,r.Lk)("div",{class:"home-container"},[e[1]||(e[1]=(0,r.Lk)("h1",null,"分帳輕鬆搞定",-1)),e[2]||(e[2]=(0,r.Lk)("p",null,"快速紀錄與分帳，讓金錢計算更簡單。",-1)),(0,r.Lk)("div",null,[(0,r.Lk)("button",{id:"btnCreateNew",class:"btn btn-success",onClick:l}," 建立新分帳 "),(0,r.Lk)("button",{id:"btnShowHis",class:"btn btn-success",onClick:d}," 檢視歷史紀錄 ")])])],64))}},Eh=n(1241);const _h=(0,Eh.A)(bh,[["__scopeId","data-v-5fa72082"]]);var Th=_h},1806:function(t,e,n){var r=n(6518),s=n(8551),i=n(2652),o=n(1767),a=[].push;r({target:"Iterator",proto:!0,real:!0},{toArray:function(){var t=[];return i(o(s(this)),a,{that:t,IS_RECORD:!0}),t}})},1795:function(t,e,n){n(1806)}}]);
//# sourceMappingURL=98.1cf397b1.js.map